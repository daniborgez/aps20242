...
public class TelaRegistrar extends javax.swing.JFrame {
    ...
    public TelaRegistrar(TelaPrincipal telaPrincipal){
    ...
    public void buscarPokemon (Integer a_id_pokemon, String nome, String categoria, String descricao, String habitat, String cor){
        this.id_Pokemon = a_id_pokemon; //instancia ou classe? ;
        this.jTextFieldNome.setText(nome);
        this.jTextFieldCategoria.setText(categoria);
        this.jTextAreaDescricao.setText(descricao);
        this.jTextFieldHabitat.setText(habitat);
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
            ...
            try{
                ...
                if(this.id_Pokemon==0){
                   sucesso = pokemonController.cadastrarPokemon(jTextFieldNome.getText(),
                           jTextFieldCategoria.getText(),
                           jTextAreaDescricao.getText()
                        , jTextFieldHabitat.getText(), jTextFieldCor.getText()); 
                }else{
                   
                     sucesso = pokemonController.alterarPokemon(this.id_Pokemon,jTextFieldNome.getText(), 
                            jTextFieldCategoria.getText(), 
                            jTextAreaDescricao.getText()
                        ,   jTextFieldHabitat.getText(), jTextFieldCor.getText());
                }
    ...
    private void abrir_telaConsulta(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_abrir_telaConsulta
        // TODO add your handling code here:
         ConsultaPokemon consultaPokemon = new ConsultaPokemon(this);
        consultaPokemon.setVisible(true);
        this.setVisible(false); 
    }//GEN-LAST:event_abrir_telaConsulta

    private void LimparEscrita(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_LimparEscrita
        // TODO add your handling code here:
        jTextFieldNome.setText("");
        jTextFieldCategoria.setText("");
        jTextFieldCor.setText("");
    ...
    private void jButtonApagarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonApagarActionPerformed
        ...
        PokemonController pokemonController = new PokemonController();
        try {
            sucesso = pokemonController.apagarFilme(this.id_Pokemon);
            if(sucesso){
                JOptionPane.showMessageDialog(null, "Registro Pokémon apagado com sucesso!");
                this.limparTela();
            }else{
                JOptionPane.showMessageDialog(null, "Erro ao apagar, por favor selecione um registro.");}
